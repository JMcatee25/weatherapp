class ForecastView {
  ...
  render() {
    const summaryEl = this.createParagraph(
      "forecast__forecast-summary",
      this.forecast.summary
    );
    const tempEl = this.createParagraph(
      "forecast__forecast-temperature",
      `${this.forecast.temperature.toFixed(0)} &#176;F`
    );
